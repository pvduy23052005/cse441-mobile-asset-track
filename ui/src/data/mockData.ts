...
export const initialWorkOrders: WorkOrder[] = [
  ...
  },
  {
    ...
    status: 'PENDING',
    downtimeStart: '2026-07-23 15:10:00',
    createdAt: '2026-07-23 15:10:00',
  },
  {
    id: 'wo-1004',
    code: 'SOS-2026-004',
    ...
    assigneeName: 'Trần Minh Đức (ME)',
    severity: 'HIGH',
    description: 'Béc hàn bị nghẹt tia lửa, đã kiểm tra vệ sinh tay gắp Robot và thay béc hàn mới. Đang chờ Quản đốc ký nghiệm thu.',
    imageUrl: 'https://images.unsplash.com/photo-1504917595217-d4dc5ebe6122?w=500&auto=format&fit=crop&q=80',
    status: 'COMPLETED',
    downtimeStart: '2026-07-23 09:30:00',
    createdAt: '2026-07-23 09:30:00',
    usedSpareParts: [
      { id: 'sp-3', name: 'Đầu béc hàn Contact Tip 1.2mm', quantity: 5, unitPrice: 150000, totalCost: 750000, requiresApproval: false, status: 'APPROVED' },
    ],
  },
  {
    id: 'wo-1005',
    code: 'SOS-2026-005',
    machineId: 'mch-401',
    machineName: 'Xe Nâng Dầu Komatsu 3.5 Tấn',
    machineCode: 'XN-401',
    reporterId: 'usr-op-01',
    reporterName: 'Nguyễn Văn Nam',
    assigneeId: 'usr-me-01',
    assigneeName: 'Trần Minh Đức (ME)',
    severity: 'LOW',
    description: 'Chảy dầu xy lanh nghiêng khung nâng, đã thay gioăng phớt thủy lực mới và được nghiệm thu đưa về trạng thái Active.',
    imageUrl: 'https://images.unsplash.com/photo-1581092335397-9583fe92d232?w=500&auto=format&fit=crop&q=80',
    status: 'APPROVED',
    downtimeStart: '2026-07-22 16:00:00',
